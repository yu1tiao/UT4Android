package com.example.ut4android.core.cookie;
...
public class PersistentCookieStore implements CookieStore, Serializable {
    private static final long serialVersionUID = -7096111790645407828L;
    private static final String TAG = "spond-cookie";
    ...
    public static PersistentCookieStore getInstance() {
        if (instance == null) {
            synchronized (PersistentCookieStore.class) {
                if (instance == null) {
                    instance = new PersistentCookieStore(App.getContext());
                }
            }
        }
        return instance;
        ...
        for (Map.Entry<String, ?> entry : allPairs.entrySet()) {
            ...
            try {
                ...
                if (cookie != null) {
                    ...
                    Log.e(TAG, "failed to decode cooke: " + uri);
                }
